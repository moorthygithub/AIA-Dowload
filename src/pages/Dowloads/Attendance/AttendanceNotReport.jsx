...
function NotAttendanceReport() {
  ...
  const onSubmit = (e) => {
    ...
    axios({
      url: BASE_URL + "/panel-download-notattend",
      method: "POST",
      data,
      headers: {
  ...
  useEffect(() => {
    ...
    //GET REPORT
    axios({
      url: BASE_URL + "/fetch-notattend-report",
      method: "POST",
      data,
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
...
export default NotAttendanceReport;
